                        ...
                        <div className="relative">
                            ...
                            <div className="absolute bottom-2 right-2">
                                <button
                                    ...
                                    className="bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 rounded-md text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                >
