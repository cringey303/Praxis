        ...
        <div className="flex min-h-screen flex-col items-center justify-center p-4 bg-background text-foreground transition-colors duration-300">
            ...
            <div className="w-full max-w-md space-y-8 bg-card p-8 rounded-xl border border-border shadow-lg">
                ...
                <div className="space-y-4">
                    ...
                    >
                        <a href={`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8080'}/auth/google/login`}>
                    ...
                    <Button
                        ...
                        className="w-full gap-2"
                    >
                        <a href={`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8080'}/auth/github/login`}>
